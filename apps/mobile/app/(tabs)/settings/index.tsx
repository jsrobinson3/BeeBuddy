...
function AccountSection() {
  ...
  const [experience, setExperience] = useState(() => deriveExperience(user?.experienceLevel));
  ...
  useEffect(() => {
    setExperience(deriveExperience(user?.experienceLevel));
  ...
  function handleExperienceChange(val: string) {
    setExperience(val);
    updateUser.mutate({ experienceLevel: val.toLowerCase() });
  }
