...
function TreatmentDetailsCard({ treatment }: { treatment: Treatment }) {
  ...
  return (
    <Card>
      ...
      <InfoRow label="Type" value={treatment.treatmentType} />
      {treatment.productName && <InfoRow label="Product" value={treatment.productName} />}
      {treatment.method && <InfoRow label="Method" value={treatment.method} />}
      {treatment.dosage && <InfoRow label="Dosage" value={treatment.dosage} />}
      <InfoRow label="Started" value={formatDate(treatment.startedAt)} />
      {treatment.endedAt && <InfoRow label="Ended" value={formatDate(treatment.endedAt)} />}
      {treatment.followUpDate && <InfoRow label="Follow-up" value={formatDate(treatment.followUpDate)} />}
    </Card>
  );
}
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Pressable
        ...
        onPress={() => router.push(`/home/treatment/edit?id=${id}` as any)}
      >
