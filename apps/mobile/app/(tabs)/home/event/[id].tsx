...
function EventDetailsCard({ event }: { event: HiveEvent }) {
  ...
  return (
    <Card>
      ...
      <InfoRow label="Type" value={EVENT_TYPE_LABELS[event.eventType] ?? event.eventType} />
      <InfoRow label="Occurred" value={formatDate(event.occurredAt)} />
    </Card>
  );
}
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Pressable
        ...
        onPress={() => router.push(`/home/event/edit?id=${id}` as any)}
      >
